...
_lr_signature = 'DIVIDE LPAREN MINUS NUMBER PLUS RPAREN TIMESexpr : expr PLUS term\n            | expr MINUS termexpr : termterm : term TIMES factor\n            | term DIVIDE factorterm : factorfactor : NUMBERfactor : LPAREN expr RPAREN'
...
_lr_productions = [
  ...
  ('expr -> expr PLUS term','expr',3,'p_expr_add_sub','parser.py',5),
  ('expr -> expr MINUS term','expr',3,'p_expr_add_sub','parser.py',6),
  ('expr -> term','expr',1,'p_expr_term','parser.py',13),
  ('term -> term TIMES factor','term',3,'p_term_mul_div','parser.py',17),
  ('term -> term DIVIDE factor','term',3,'p_term_mul_div','parser.py',18),
  ('term -> factor','term',1,'p_term_factor','parser.py',27),
  ('factor -> NUMBER','factor',1,'p_factor_num','parser.py',31),
  ('factor -> LPAREN expr RPAREN','factor',3,'p_factor_expr','parser.py',35),
]
